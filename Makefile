...
# my.domain/harness-gitops-agent-operator-bundle:$VERSION and my.domain/harness-gitops-agent-operator-catalog:$VERSION.
IMAGE_TAG_BASE ?= my.domain/harness-gitops-agent-operator
